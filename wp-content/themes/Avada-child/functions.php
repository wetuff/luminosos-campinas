...
function child_enqueue_styles() {
	...
	//wp_enqueue_style( 'fontawesome-style', get_stylesheet_directory_uri() . '/fontawesome-all.min.css' );
	//wp_enqueue_script( 'funcoes', get_stylesheet_directory_uri() . '/funcoes.js' );
	//wp_enqueue_script( 'jquery.flexslider-min', get_stylesheet_directory_uri() . '/jquery.flexslider-min.js' );
